...
// UTF-8 encoded string from: Num%C3%A9ro%20d'Identification%20(NINU)
static const unsigned char widget_text_2[] = {0x4e, 0x75, 0x6d, 0xc3, 0xa9, 0x72, 0x6f, 0x20, 0x64, 0x27, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x20, 0x28, 0x4e, 0x49, 0x4e, 0x55, 0x29, 0};
// UTF-8 encoded string from: V%C3%A9rifier
static const unsigned char widget_text_3[] = {0x56, 0xc3, 0xa9, 0x72, 0x69, 0x66, 0x69, 0x65, 0x72, 0};
...
// UTF-8 encoded string from: En%20attente%20de%20NINU...
static const unsigned char widget_text_5[] = {0x45, 0x6e, 0x20, 0x61, 0x74, 0x74, 0x65, 0x6e, 0x74, 0x65, 0x20, 0x64, 0x65, 0x20, 0x4e, 0x49, 0x4e, 0x55, 0x2e, 0x2e, 0x2e, 0};
// UTF-8 encoded string from: Bureau%20de%20Vote
static const unsigned char widget_text_6[] = {0x42, 0x75, 0x72, 0x65, 0x61, 0x75, 0x20, 0x64, 0x65, 0x20, 0x56, 0x6f, 0x74, 0x65, 0};
// UTF-8 encoded string from: %E2%80%94
static const unsigned char widget_text_7[] = {0xe2, 0x80, 0x94, 0};
// UTF-8 encoded string from: S%C3%A9lection%20du%20Candidat
static const unsigned char widget_text_8[] = {0x53, 0xc3, 0xa9, 0x6c, 0x65, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x20, 0x64, 0x75, 0x20, 0x43, 0x61, 0x6e, 0x64, 0x69, 0x64, 0x61, 0x74, 0};
...
static void vote_page_load_template(ui_widget_t *parent, vote_page_refs_t *refs)
{
        ...
        ui_widget_add_class(w[4], "flex flex-col mb-4");
        ...
        ui_widget_add_class(w[6], "flex flex-row items-center");
        refs->ninu = ui_create_widget("textinput");
        ui_widget_add_class(refs->ninu, "flex-1 mr-2");
        ...
        ui_widget_add_class(w[7], "text-label-md text-on-surface font-medium");
        ui_widget_set_text(w[7], (const char*)widget_text_3);
        ui_widget_append(refs->ref_1, w[7]);
        ui_widget_append(w[6], refs->ninu);
        ui_widget_append(w[6], refs->ref_1);
        ...
        ui_widget_add_class(w[8], "flex flex-row flex-wrap mb-2");
        w[9] = ui_create_widget(NULL);
        ui_widget_add_class(w[9], "flex-1 flex flex-col mr-2 mb-2");
        ui_widget_set_style_string(w[9], "min-width", "180px");
        w[10] = ui_create_widget("text");
        ui_widget_add_class(w[10], "text-body-sm text-secondary mb-1");
        ui_widget_set_text(w[10], (const char*)widget_text_4);
        w[11] = ui_create_widget(NULL);
        ui_widget_add_class(w[11], "bg-surface-container-low border border-outline-variant rounded px-3 py-2");
        refs->electeur_nom = ui_create_widget("text");
        ui_widget_add_class(refs->electeur_nom, "text-body-md text-secondary");
        ui_widget_set_text(refs->electeur_nom, (const char*)widget_text_5);
        ui_widget_append(w[11], refs->electeur_nom);
        ui_widget_append(w[9], w[10]);
        ui_widget_append(w[9], w[11]);
        w[12] = ui_create_widget(NULL);
        ui_widget_add_class(w[12], "flex flex-col w-40");
        ...
        ui_widget_add_class(w[14], "bg-surface-container-low border border-outline-variant rounded px-3 py-2");
        refs->electeur_bv = ui_create_widget("text");
        ui_widget_add_class(refs->electeur_bv, "text-body-md text-secondary");
        ui_widget_set_text(refs->electeur_bv, (const char*)widget_text_7);
        ui_widget_append(w[14], refs->electeur_bv);
        ...
        ui_widget_add_class(w[15], "border-b border-outline-variant mt-2 mb-4");
        w[16] = ui_create_widget("text");
        ui_widget_add_class(w[16], "text-body-sm font-medium text-on-surface mb-2");
        ...
        ui_widget_add_class(w[17], "flex flex-row items-center");
        ...
        ui_widget_add_class(w[18], "text-label-md text-secondary font-medium");
        ui_widget_set_text(w[18], (const char*)widget_text_9);
        ui_widget_append(refs->ref_6, w[18]);
        ...
        ui_widget_add_class(w[19], "text-label-md text-on-primary font-medium");
        ui_widget_set_text(w[19], (const char*)widget_text_10);
        ui_widget_append(refs->ref_7, w[19]);
        ui_widget_append(w[17], refs->ref_6);
        ui_widget_append(w[17], refs->ref_7);
        ...
        ui_widget_append(w[3], w[8]);
        ui_widget_append(w[3], w[15]);
        ui_widget_append(w[3], w[16]);
        ui_widget_append(w[3], refs->candidats);
        ui_widget_append(w[3], w[17]);
        ui_widget_append(w[3], refs->vote_msg);
        w[20] = ui_create_widget(NULL);
        ui_widget_add_class(w[20], "flex flex-row items-center mt-4");
        w[21] = ui_create_widget("text");
        ui_widget_add_class(w[21], "fui-icon-regular text-secondary mr-1");
        ui_widget_set_style_string(w[21], "font-size", "12px");
        ui_widget_set_text(w[21], (const char*)widget_text_11);
        w[22] = ui_create_widget("text");
        ui_widget_add_class(w[22], "text-label-sm text-secondary");
        ui_widget_set_text(w[22], (const char*)widget_text_12);
        ui_widget_append(w[20], w[21]);
        ui_widget_append(w[20], w[22]);
        ui_widget_append(parent, w[0]);
        ui_widget_append(parent, w[3]);
        ui_widget_append(parent, w[20]);
}
