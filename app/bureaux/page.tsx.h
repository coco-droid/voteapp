...
static const unsigned char widget_text_0[] = {0x42, 0x75, 0x72, 0x65, 0x61, 0x75, 0x78, 0x20, 0x64, 0x65, 0x20, 0x56, 0x6f, 0x74, 0x65, 0};
// UTF-8 encoded string from: G%C3%A9rez%20les%20bureaux%20de%20vote%20et%20leurs%20membres%20(pr%C3%A9sident%2C%20vice-pr%C3%A9sident%2C%20secr%C3%A9taire).
static const unsigned char widget_text_1[] = {0x47, 0xc3, 0xa9, 0x72, 0x65, 0x7a, 0x20, 0x6c, 0x65, 0x73, 0x20, 0x62, 0x75, 0x72, 0x65, 0x61, 0x75, 0x78, 0x20, 0x64, 0x65, 0x20, 0x76, 0x6f, 0x74, 0x65, 0x20, 0x65, 0x74, 0x20, 0x6c, 0x65, 0x75, 0x72, 0x73, 0x20, 0x6d, 0x65, 0x6d, 0x62, 0x72, 0x65, 0x73, 0x20, 0x28, 0x70, 0x72, 0xc3, 0xa9, 0x73, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x2c, 0x20, 0x76, 0x69, 0x63, 0x65, 0x2d, 0x70, 0x72, 0xc3, 0xa9, 0x73, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x2c, 0x20, 0x73, 0x65, 0x63, 0x72, 0xc3, 0xa9, 0x74, 0x61, 0x69, 0x72, 0x65, 0x29, 0x2e, 0};
// UTF-8 encoded string from: %EE%A9%BC
static const unsigned char widget_text_2[] = {0xee, 0xa9, 0xbc, 0};
// UTF-8 encoded string from: %2B%20Nouveau%20bureau
static const unsigned char widget_text_3[] = {0x2b, 0x20, 0x4e, 0x6f, 0x75, 0x76, 0x65, 0x61, 0x75, 0x20, 0x62, 0x75, 0x72, 0x65, 0x61, 0x75, 0};
// UTF-8 encoded string from: Nouveau%20bureau%20de%20vote
...
static const unsigned char widget_text_9[] = {0x49, 0x44, 0x20, 0x56, 0x69, 0x63, 0x65, 0x2d, 0x50, 0x72, 0xc3, 0xa9, 0x73, 0x69, 0x64, 0x65, 0x6e, 0x74, 0x20, 0x2a, 0};
// UTF-8 encoded string from: ID%20Secr%C3%A9taire%20*
static const unsigned char widget_text_10[] = {0x49, 0x44, 0x20, 0x53, 0x65, 0x63, 0x72, 0xc3, 0xa9, 0x74, 0x61, 0x69, 0x72, 0x65, 0x20, 0x2a, 0};
// UTF-8 encoded string from: Une%20m%C3%AAme%20personne%20ne%20peut%20occuper%20qu'un%20seul%20poste%2C%20dans%20un%20seul%20bureau.
...
typedef struct bureaux_page_react_state {
        char empty;
} bureaux_page_react_state_t;

typedef struct bureaux_page_react {
        bureaux_page_react_state_t state;
        bureaux_page_refs_t refs;
} bureaux_page_react_t;

static ui_widget_prototype_t *bureaux_page_proto;

static void bureaux_page_init_prototype(void)
{
        bureaux_page_proto = ui_create_widget_prototype("bureaux_page", NULL);
}
...
static void bureaux_page_load_template(ui_widget_t *parent, bureaux_page_refs_t *refs)
{
        ...
        ui_widget_set_attr(refs->recherche, "placeholder", "Rechercher par ID ou adresse...");
...
{
        bureaux_page_react_t *_that = ui_widget_get_data(w, bureaux_page_proto);
        bureaux_page_load_template(w, &_that->refs);
        bureaux_page_react_init_events(w);
}

static void bureaux_page_react_destroy(ui_widget_t *w)
{
}

void ui_load_bureaux_page_resources(void)
{
}
